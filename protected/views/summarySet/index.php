<?php
$this->pageTitle=Yii::app()->name . ' - SummarySet';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Summary Set'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        ...
        'model'=>$model,
        'viewhdr'=>'//summarySet/_listhdr',
        'viewdtl'=>'//summarySet/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
...
$ajaxUrl = Yii::app()->createUrl('summarySet/ajaxSave');
$js = "
...
$('.update-row').click(function(){
    ...
    $('#summaryModal span[data-id=\"city_name\"]').text(city_name);
    $('#summaryModal').modal('show');
});

$('#btnSave').click(function(){
    var formData = {};
    formData['summary_year'] = '{$model->summary_year}';
...
";
if(Yii::app()->user->validRWFunction('G04')){
