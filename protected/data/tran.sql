CREATE DATABASE txn CHARACTER SET utf8 COLLATE utf8_general_ci;

GRANT SELECT, INSERT, UPDATE, DELETE ON txn.* TO 'swuser'@'localhost' IDENTIFIED BY 'swisher168';
...
INSERT INTO txn_table(cat, last_id) VALUES
('service',0),
('servicecontract',0),
('company',0),
('contact',0),
...
DROP TABLE IF EXISTS `txnService`;
CREATE TABLE `txnService` (
  `txn_id` int unsigned not null auto_increment primary key,
  `txn_date` timestamp default CURRENT_TIMESTAMP,
  `txn_action` char(1) NOT NULL, 
  `ServiceType` int(11) NOT NULL,
  `ServiceName` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  `Skills` int(10) unsigned NOT NULL,
  `ServiceCode` varchar(20) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
