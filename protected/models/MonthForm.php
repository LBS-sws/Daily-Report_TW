...
class MonthForm extends CFormModel
{
    ...
    public function retrieveData($index,$city) {
        ...
        if(count($rows)==64){
            ...
            $be104=($bc104>0.35?5:($bc104>=0.26?4:($bc104>=0.17?3:($bc104>=0.08?2:($bc104>0?1:0)))));

            $e76=($c76>=0.15?5:($c76>=0.9?4:($c76>=0?3:($c76>=-0.14?2:($c76>=-0.3?1:0)))));
            $e77=($c77>=0.15?5:($c77>=0.9?4:($c77>=0?3:($c77>=-0.14?2:($c77>=-0.3?1:0)))));
            $e78=($c78>=0.3?5:($c78>=0.2?4:($c78>=0.05?3:($c78>=-0.09?2:($c78>=-0.2?1:0)))));
            $e79=($c79>=0.3?5:($c79>=0.2?4:($c79>=0.05?3:($c79>=-0.09?2:($c79>=-0.2?1:0)))));
            $e80=($c80>=1.5?5:($c80>=1?4:($c80>=0?3:($c80>=-0.99?2:($c80>-2?1:0)))));
            $e81=($c81>=1.5?5:($c81>=1?4:($c81>=0?3:($c81>=-0.99?2:($c81>-2?1:0)))));
            $e82=($c82>=0.15?5:($c82>=0.09?4:($c82>=0?3:($c82>=-0.09?2:($c82>=-0.2?1:0)))));
            $e83=($c83>=0.15?5:($c83>=0.09?4:($c83>=0?3:($c83>=-0.15?2:($c83>=-0.3?1:0)))));
            $e84=($c84>2.3?1:($c84>1.5?3:($c84>=1?5:($c84>0.7?4:($c84>0.4?2:($c84>0.2?1:0))))));
            $e85=($c85>=1?1:($c85>=0.8?3:($c85>=0.6?5:($c85>=0.4?4:($c85>=0.2?2:($c85>=0.05?1:0))))));
            $e86=($c86>=0.039?1:($c86>=0.029?2:($c86>=0.02?3:($c86>=0.009?4:($c86>=0?5:5)))));
            $e88=($c88>=0.2?5:($c88>=0?4:($c88>=-0.09?3:($c88>=-0.19?2:($c88>=-0.29?1:0)))));
            $e89=($c89>0.7?5:($c89>0.3?4:($c89>0.1?3:0)));
            $e90='NIL';
            $e91=($c91>0.31?0:($c91>=0.26?1:($c91>=0.21?2:($c91>=0.16?3:($c91>=0.11?4:5)))));
            $e92=($c92>0.26?0:($c92>=0.21?1:($c92>=0.16?2:($c92>=0.11?3:($c92>=0.06?4:5)))));
            $e93=($c93>0.2?5:($c93>0.1?3:($c93>0.05?1:0)));
            $e94='NIL';
            $e96=($c96>=0.55?5:($c96>=0.5?4:($c96>=0.45?3:($c96>=0.4?2:($c96>=0.36?1:0)))));
            $e97=($c97>0.5?1:($c97>=0.4?2:($c97>=0.35?3:($c97>=0.25?3:($c97>=0.2?5:0)))));
            $e98=($c98>1?5:($c98>0.95?4:($c98>0.9?3:($c98>0.85?2:($c98>0.8?1:0)))));
            $e99='NIL';
            $e100=($c100>=0.8?0:($c100>=0.61?1:($c100>=0.51?2:($c100>=0.41?3:($c100>=0.31?4:5)))));
            $e102=($c102>0.95?5:($c102>0.9?4:($c102>0.85?3:($c102>0.8?2:($c102>=0.75?1:0)))));
            $e103=($c103>0.95?5:($c103>0.9?4:($c103>0.85?3:($c103>0.8?2:($c103>=0.75?1:0)))));
            $e104=($c104>0.95?5:($c104>0.9?4:($c104>0.85?3:($c104>0.8?2:($c104>=0.75?1:0)))));
            $e105='NIL';
            ...
            $e112=($c112>0.95?5:($c112>0.9?4:($c112>0.85?3:($c112>0.8?2:($c112>=0.75?1:0)))));
            $e113=($c113>=0.08?5:($c113>=0.06?3:($c113>=0.04?1:0)));
            $e114=($c114>0.95?5:($c114>0.9?4:($c114>0.85?3:($c114>0.8?2:($c114>=0.75?1:0)))));
            $e115='NIL';
            $e117=($c117>=6?0:($c117>=4?3:($c117>=1?4:5)));
            $e118=($c118>0.31?0:($c118>=0.21?1:($c118>=0.11?3:5)));
            $e119=($c119>0.6?1:($c119>0.2?3:5));
            $e120=($c120>0.16?0:($c120>=0.11?1:($c120>=0.06?3:5)));
            $e121=($c121>1?5:($c121>0.8?3:1));
            $e122=($c122>1?5:($c122>0.8?3:1));
            $e124=($c124>0.31?0:($c124>=0.21?1:($c124>=0.11?3:5)));
