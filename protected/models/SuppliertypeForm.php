...
class SuppliertypeForm extends CFormModel
{
	/* User Fields */
	public $id;
	public $description;
	...
	{
		$sql = "select * from swo_supplier_type where id=".$index."";
	...
	protected function saveUser(&$connection)
	{
		...
		switch ($this->scenario) {
			case 'delete':
				$sql = "delete from swo_supplier_type where id = :id";
				break;
			case 'new':
				$sql = "insert into swo_supplier_type(
						description, rpt_cat, luu, lcu) values (
						:description, :rpt_cat, :luu, :lcu)";
				break;
			case 'edit':
				$sql = "update swo_supplier_type set 
