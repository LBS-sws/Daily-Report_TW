...
class ServiceTypeForm extends CFormModel
{
	...
	public function retrieveData($index)
	{
		...
		$sql = "select * from swo_service_type where id=".$index." ";
	...
	protected function saveUser(&$connection)
	{
		...
		switch ($this->scenario) {
			case 'delete':
				$sql = "delete from swo_service_type where id = :id";
				break;
			case 'new':
				$sql = "insert into swo_service_type(
						description, rpt_cat, lcu, luu) values (
						:description, :rpt_cat, :lcu, :luu)";
				break;
			case 'edit':
				$sql = "update swo_service_type set 
